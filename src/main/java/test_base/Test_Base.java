...
public class Test_Base
{
	...
	public Test_Base()
	{
		try
		{
			FileInputStream fis = new FileInputStream("E:\\QA_Infotech\\Training_Works\\Eclipse\\Workspace_2\\Projects\\Gmail_Automation\\src\\main\\java\\config\\config.properties");
			prop = new Properties();
			prop.load(fis);
		}
		catch(Exception e)
